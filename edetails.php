   ...
   <?php                 
    ...
    <section class="content-header"> 
     ...
     <h1><?php echo $row['name'];?>
          ...
          <small><?php echo $row['joining_date'];?> </small>
          <div class="set">
            <a href=<?php echo "http://localhost/hrmanager/eedit.php?id=",urlencode($row['id']);?> data-toggle="tooltip" title="Edit"><img class="img-responsive" src="http://localhost/hrmanager/uploads/cog.png" /></a>
          </div>
        </section>
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="profile-img">
                    <img class="img-responsive img-circle" src= 'http://localhost/hrmanager/uploads/dd.jpg';" src="http://localhost/hrmanager/uploads">
                  </div>
                  <div class="profile-detail">
                    ...
                    <h4 class="text-orange">Related Dcouments</h4>
                    <table class="table table-striped">
                      <thead>
                        <tr>
                          <th>File name</th>
                      ...
                      <tbody>
                        <tr>
                          <td>CV</td>
                          <td>
                            <a href="#" data-toggle="tooltip" title="Download" class="btn btn-success btn-flat" type="submit"><i class="fa fa-fw fa-download"></i></a>
                                                       
                           <a href="#" data-toggle="tooltip" title="Delete" class="btn btn-danger btn-flat" type="submit">
                ...
                <div class="col-sm-8">
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                      <li class="active"><a href="#" data-toggle="tab"><i class="fa fa-fw fa-bar-chart"></i> Evaluation graph</a></li>
                      <li><a href="#" data-toggle="tab"><i class="fa fa-fw fa-bullseye"></i> Attendance</a></li>
                    </ul>
                    <div class="tab-content">
                      <div class="tab-pane active" id="tab_1">
                        <div class="gBAr">
                          <h4 class="text-orange">Evaluation graph ( Jan - April )</h4>
                          <div class="bArrow">
                            <ul>
                          ...
                          <div class="graphNote">
                            <ul>
                              <li>
                                <div class="legends" style="background-color: #7fb5da"></div> New visit
                              </li>
                              <li>
                                <div class="legends" style="background-color: #ffca3a"></div> Follow up
                              </li>
                              <li>
                                <div class="legends" style="background-color: #95da7f"></div> Success
                              </li>
                              <li>
                                <div class="legends" style="background-color: #f66060"></div> Declined
                              </li>
                            </ul>
                          </div>
                        </div>
                      ...
                      <div class="tab-pane" id="tab_2">
                        <div class="gBAr">
                          <h4 class="text-orange">Attendance graph ( Jan - March )</h4>
                          <div class="bArrow">
                            <ul>
                              <li><a href="#"><i class="fa fa-fw fa-angle-left"></i></a></li>
                              <li><a href="#" ><i class="fa fa-fw fa-angle-right"></i></a></li>
                          ...
                          <canvas id="barChart2" height="300"></canvas>
                          <div class="graphNote">
                            <ul>
                              <li>
                                <div class="legends" style="background-color: #3790d5"></div> Present
                              </li>
                              <li>
                                <div class="legends" style="background-color: #ffca3a"></div> Absent
                              </li>
                              <li>
                                <div class="legends" style="background-color: #2aa405"></div> Paid leave
                              </li>
                            </ul>
                          </div>
                        </div>
