...
<head>
  ...
  <title>HR MANAGER | Empolyee Register</title>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="http://localhost/hrmanager/signout.phpFe" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
...
<section class="content">
  <div class ="box">
    ...
    <div class="nav-tabs-custom">
                            <form method="post" action="eupdation.php" enctype="multipart/form-data">

                              <div class="row"> 
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="fullname">Full name</label>
                                    <input name="full_name" class="form-control" type="text" placeholder="Enter full name" value="<?php echo $row['name'];?>"><div id="msg"></div>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <input name="address" class="form-control" type="text" value="<?php echo $row['address'];?>"><div id="msg"></div>
                              </div>
                              </div>
                              <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <option selected disabled>Please Select Employee Role</option> 
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="primary_phone" data-mask="" data-inputmask="&quot;mask&quot;: &quot;(999) 999-9999&quot;" class="form-control"  value="<?php echo $row['primary_phone'];?>"><div id="msg"></div>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="phone">Secondary Phone</label>
                                    <input type="text" name="sphone" data-mask="" data-inputmask="&quot;mask&quot;: &quot;(999) 999-9999&quot;" class="form-control"  value="<?php echo $row['secondary_phone'];?>"><div id="msg"></div>
                                  </div>
                                </div>
                              </div>
                               ...
                               <div class="row">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <input name="username" class="form-control" type="text"  value="<?php echo $row['username'];?>"><div id="msg"></div>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="password">Password</label>
                                     <input name="password" class="form-control" type="password" value="<?php echo $row['password'];?>"><div id="msg"></div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input name="email_address" class="form-control" type="email_address" value="<?php echo $row['email'];?>"><div id="msg"></div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="joining_date" data-mask="" data-inputmask="'alias': 'yyyy/mm/dd'" class="form-control" placeholder="Enter Joining date" value="<?php echo $row['joining_date'];?>">
                                  </div><div id="msg"></div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="post">Post</label>
                                    <input name="post" class="form-control" type="text" placeholder="Enter assigned post" value="<?php echo $row['assigned_post'];?>"><div id="msg"></div>
                                  </div>
                                </div>
                              </div>                  
                              ...
                              <div class="form-group">
                                    ...
                                    <input id="profile_pic" name="profile_pic" type="file" multiple value="<?php echo $row['photo'];?>">
                                 <p class="help-block">Select the files related to the project.</p><div id="msg"></div>
                             </div>

                              <div class="form-group">
                                  <label for="cv">Upload CV</label>
                                  <input id="cv" name="cv" type="file" multiple value="<?php echo $row['cv'];?>">
                                 <div id="msg"></div>
                              </div>

                             <div class="form-group">
                                <label>Additional Information/Remarks</label>
                                <textarea name="addInfo" class="form-control" value="<?php echo $row['info'];?>" rows="3"></textarea><div id="msg"></div>
                              </div>
...
</form><!-- Administrative staff form ends -->
                        </div>
                    </div>
                 </div>
              </div>
