            ...
            <div class="box-body">
              <form action="project.php" method="post" enctype="multipart/form-data">       
                  <div class="form-group">
                    ...
                    <input id="project_name" name="project_name" class="form-control" type="text"  value="<?php echo $row['project_name'];?>"><div id="msg"></div>
                  </div> 
                  <div class="row input_fields_wrap">
                    <div class="col-sm-6">
                      <div class="form-group ">
                        <label>Assign Employee</label>
                        <input name="assignemployee" id="assignemployee_1" value="<?php echo $row['assigned_employee'];?>" class="form-control assignemployee" type="text"  class = "default">  
                        <div id="msg"></div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group ">
                        <label>Role</label>
                        <input name="role" id="role_1"  class="form-control role" type="text" value="<?php echo $row['role'];?>"><div id="msg"></div>
                      </div>
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                    <label>Address *</label>
                    <input id="address" name="project_address" class="form-control" type="text"  value="<?php echo $row['address'];?>"><div id="msg"></div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="fullname">Contact person *</label>
                        <input id="contactperson" name="contact_person" class="form-control" type="text"  value="<?php echo $row['contact_person'];?>"><div id="msg"></div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                       <div class="form-group">
                        <label for="fullname">Position</label>
                        <input id="position" name="position" class="form-control" type="text"  value="<?php echo $row['position'];?>"><div id="msg"></div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input id="phone" name="phone_number" class="form-control" type="text" value="<?php echo $row['phone_number'];?>"><div id="msg"></div>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="fullname">Email address</label>
                        <input id="email" name="email_address" class="form-control" type="text" value="<?php echo $row['email'];?>"><div id="msg"></div>
                      </div>
                    </div>
                  </div>                  
                  ...
                  <div class="form-group">
                    <label for="fullname">Description</label>
                     <textarea class="textarea" name="project_description"  value="<?php echo $row['description'];?>"  style="width: 100%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                  </div>

                  <div class="form-group">
                    <label for="projectFile">Upload files</label>
                    <input id="project_files" name="project_files" type="file" value="<?php echo $row['upload_file'];?>" multiple>
                    <p class="help-block">Select the files related to the project.</p><div id="msg"></div>
                      ...
                      <div class="form-group">
                        ...
                        <input id="file_title" name="file_title" class="form-control" type="text"  value="<?php echo $row['file_title'];?>"><div id="msg"></div>
                      </div>
                    

                  <div class="form-group">
                    <label for="fullname">Tags</label>
                    <input id="tags" name="tags" class="form-control" type="text"  value="<?php echo $row['tags'];?>"><div id="msg"></div>
                  </div>
