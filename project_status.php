...
<head>
  ...
  <title>HR MANAGER | Status Update</title>
            ...
            <div class="box-body">
              <form action="status_update.php" method="post" >       
                  <div class="form-group">
                    <label for="fullname">Project Status</label>
                    <input id="project_status" name="project_status" class="form-control" type="text" placeholder="Enter project Status"><div id="msg"></div>
                  </div> 
                   <div class="form-group">
