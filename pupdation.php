...
if (mysqli_connect_errno())
{
  ...
  $sql=="UPDATE  `project` SET `project_name` = '".$pname."', `assigned_employee` = '".$members."',, `role` = '".$role."'`address` ='".$address."', `contact_person` = '".$contact."',`position` ='".$position."',`phone_number` = '".$phone."', `email` = '".$email."',`description` ='".$description."',`upload_file` = '".$name."', `file_title` = '".$file_title."',`tags` ='".$tags."' WHERE `id`=$id";
