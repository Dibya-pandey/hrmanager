...
<head>
  ...
  <title>HR MANAGER | Employee Lists</title>
            ...
            while($row=mysqli_fetch_array($result, MYSQLI_ASSOC ))
                     {
                       ...
                       ?>
                        <td><?php echo $i++;?> </td>
                  <td><?php echo "<a href=http://localhost/hrmanager/edetails.php?id=",urlencode($row['id']),">".$row['name']."</a>";?>
                       </td>
                    <td><?php echo $row['address'] ;?></td>
                     <td><?php echo $row['assigned_post']; ?></td>
                      <td><?php echo $row['primary_phone'] ;?></td>
                      <td>
                       <a href=<?php echo "http://localhost/hrmanager/edetails.php?id=",urlencode($row['id']);?> data-toggle="tooltip" title="View Detail" class="btn btn-success btn-flat" type="button">
                       <i class="fa fa-fw fa-eye"></i>
                       </a>
                       <a href=<?php echo "http://localhost/hrmanager/edelete.php?id=",urlencode($i);?> class="btn btn-danger btn-flat" title="Delete">
