...
<section class="content">
  <div class ="box">
    ...
    <div class="nav-tabs-custom">
                            <form method="post" action="eregistration.php" enctype="multipart/form-data">

                              <div class="row"> 
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="fullname">Full name</label>
                                    <input name="full_name" class="form-control" type="text" placeholder="Enter full name" value=""><div id="msg"></div>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                ...
                                <input name="address" class="form-control" type="text" placeholder="Enter address" value=""><div id="msg"></div>
                              </div>
                              </div>
                              <div class="col-sm-6">
                                  <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="primary_phone" data-mask="" data-inputmask="&quot;mask&quot;: &quot;(999) 999-9999&quot;" class="form-control" placeholder="Enter phone" value=""><div id="msg"></div>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="phone">Secondary Phone</label>
                                    <input type="text" name="sphone" data-mask="" data-inputmask="&quot;mask&quot;: &quot;(999) 999-9999&quot;" class="form-control" placeholder="Enter phone" value=""><div id="msg"></div>
                                  </div>
                                </div>
                              </div>
                               ...
                               <div class="row">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <input name="username" class="form-control" type="text" placeholder="Enter username" value=""><div id="msg"></div>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="password">Password</label>
                                     <input name="password" class="form-control" type="password" placeholder="Enter password"><div id="msg"></div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input name="email_address" class="form-control" type="email_address" placeholder="Enter email" value=""><div id="msg"></div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="joining_date" data-mask="" data-inputmask="'alias': 'yyyy/mm/dd'" class="form-control" placeholder="Enter Joining date" value="">
                                  </div><div id="msg"></div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label for="post">Post</label>
                                    <input name="post" class="form-control" type="text" placeholder="Enter assigned post" value=""><div id="msg"></div>
                                  </div>
                                </div>
                              </div>                  
                              ...
                              <div class="form-group">
                                    ...
                                    <input id="profile_pic" name="profile_pic" type="file" multiple>
                             ...
                             <div class="form-group">
                                ...
                                <textarea name="addInfo" class="form-control" placeholder="Enter Additonal Information" rows="3"></textarea><div id="msg"></div>
                              </div>
